...
Since this uses Regex matching rules, no human will be forced to update this manually. Use one of the suggested cloud LLMs ("AI") or you local one of choice to handle this. Double check for [hallucinations](https://en.m.wikipedia.org/wiki/Hallucination_(artificial_intelligence)) to make sure it's correct.
<br>
